...
var sF$=(function(){
  ...
  function fnShowPrice(Price,OriginalPrice,Cod,iMaxParcels,ProductID){
    ...
    if(typeof Juros!="undefined"){
      ...
      if(Juros[iMaxParcels-1]>0)sInterest=""; else sInterest=" sem juros <font face=Calibri style=font-size: 9pt color=#6A6666>ou <b>à vista</b> com<br><b>10% de desconto</b> (<b>Depósito ou Boleto</b>)</font>";
    }
    else{
      iMaxParcels=0;
    }
  ...
  function fnShowParcels(Price,iMaxParcels,ProductID){
    ...
    if(typeof Juros!="undefined"){
      if(iMaxParcels==0||iMaxParcels>Juros.length)iMaxParcels=Juros.length;
      if(Juros[iMaxParcels-1]>0)sInterest=""; else sInterest=" sem juros ou <b>à vista</b> com<br>10% de desconto (<b>Depósito ou Boleto</b>)";      
    }
    else{
      iMaxParcels=0;
    }
    if(iMaxParcels>1 && Price>=1)sPrice+="<div class=\"installments\">em <strong><span class=\"installment-count\">"+ iMaxParcels +"</span>x</strong> dee <strong><span class=\"installment-price\">"+FormatPrice(CalculaParcelaJurosCompostos(Price,iMaxParcels),FC$.Currency)+"</span></strong>"+ sInterest +"</div>";
...
function fnMaxInstallmentsGrid(PrecoProd,MaxParcelas){
  ...
  if(typeof Juros!="undefined"){
    ...
    return "<span class=EstParc> em <b>"+MaxParcelas+"x</b>"+ComSem+" de <b>"+FormatPrice(CalculaParcelaJurosCompostos(PrecoProd,MaxParcelas),FC$.Currency)+"</b> ou</span>";
  }else{
    return "";
...
function fnShowEconomyGrid(ProdPrice,ProdPriceOri){
  if(ProdPrice!=ProdPriceOri && typeof FormatNumber == 'function' && typeof FormatPrice == 'function' ){
    return "<br><br><b><font style='font-size:30px;' color=#000000>"+ FormatPrice(ProdPrice*0.90,FC$.Currency) +"</font></b><font style='font-size:14px;' color=#333333> à vista no <b>(Boleto ou Depósito)</b><br><font style='font-size:16px;display:block;margin:10px 0;' color=#6f9e45>Economize <b>"+ FormatPrice(ProdPriceOri-ProdPrice,FC$.Currency) +"</b> ("+ FormatNumber(((ProdPriceOri-ProdPrice)/ProdPriceOri)*100)+"%)</font>";
  }else{return "<br><br><b><font style='font-size:30px;' color=#000000>"+ FormatPrice(ProdPrice*0.90,FC$.Currency) +"</font></b><font style='font-size:14px;' color=#333333> à vista no <b>(Boleto ou Depósito)</b></font>";}
}
